...
{
    public class HeadFactory : BodyPartFactory
    {
        public HeadFactory(Structure? structure) : base(structure)
        {
        }
        ...
        public override void GenerateBodyPart(Structure? structure)
        {
            ...
            // set stat base for head
            this._bodyPart.PartStats[Stat.Alacrity] += .1f;
            this._bodyPart.PartStats[Stat.Strength] += .1f;
            this._bodyPart.PartStats[Stat.Endurance] += .1f;
            this._bodyPart.PartStats[Stat.Technique] += .4f;
            ...
            // roll each stat
            this._bodyPart.PartStats[Stat.Alacrity] *= _rng.Next(1, 20);
            this._bodyPart.PartStats[Stat.Strength] *= _rng.Next(1, 15);
            this._bodyPart.PartStats[Stat.Endurance] *= _rng.Next(1, 20);
            this._bodyPart.PartStats[Stat.Technique] *= _rng.Next(5, 20);
            ...
            this._bodyPart.PartStats[Stat.Alacrity] *= StaticReference.RarityMultiplier[this._bodyPart.PartRarity] / 2f;
            this._bodyPart.PartStats[Stat.Strength] *= StaticReference.RarityMultiplier[this._bodyPart.PartRarity] / 5f;
            this._bodyPart.PartStats[Stat.Endurance] *= StaticReference.RarityMultiplier[this._bodyPart.PartRarity] / 3f;
            this._bodyPart.PartStats[Stat.Technique] *= StaticReference.RarityMultiplier[this._bodyPart.PartRarity] / 1f;
        }
