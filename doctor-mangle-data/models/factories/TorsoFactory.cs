...
{
    public class TorsoFactory : BodyPartFactory
    {
        public TorsoFactory(Structure? structure) : base(structure)
        {
        }

        public override void GenerateBodyPart(Structure? structure)
        {
            this._bodyPart = new Torso();
            ...
            this._bodyPart.PartStats[Stat.Endurance] += .8f;
            ...
            // roll each stat
            this._bodyPart.PartStats[Stat.Alacrity] *= _rng.Next(1, 15);
            this._bodyPart.PartStats[Stat.Strength] *= _rng.Next(5, 20);
            this._bodyPart.PartStats[Stat.Endurance] *= _rng.Next(10, 20);
            this._bodyPart.PartStats[Stat.Technique] *= _rng.Next(1, 15);
            ...
            this._bodyPart.PartStats[Stat.Alacrity] *= StaticReference.RarityMultiplier[this._bodyPart.PartRarity] / 3f;
            this._bodyPart.PartStats[Stat.Strength] *= StaticReference.RarityMultiplier[this._bodyPart.PartRarity] / 2f;
            this._bodyPart.PartStats[Stat.Endurance] *= StaticReference.RarityMultiplier[this._bodyPart.PartRarity] / 1f;
