...
namespace doctor_mangle.models.factories
{
    public class ArmFactory : PairedBodyPartFactory
    {
        ...
        public override void GenerateBodyPart(Structure? structure)
        {
            ...
            // roll each stat
            this._bodyPart.PartStats[Stat.Alacrity] *= _rng.Next(5, 20);
            this._bodyPart.PartStats[Stat.Strength] *= _rng.Next(10, 20);
            ...
            this._bodyPart.PartStats[Stat.Strength] *= StaticReference.RarityMultiplier[this._bodyPart.PartRarity] / 1f;
